...
const PaymentReturnPage = () => {
  ...
  useEffect(() => {
    const checkPaymentStatus = async () => {
      try {
        // Get data from URL parameters (PayOS callback)
        ...
        // Get stored order data from memory or API
        ...
        if (cancel === "true" || status === "CANCELLED") {
          ...
          // const paymentResult = await verifyPayment(id || orderCode);
        } else if (code && code !== "00") {
          finalStatus = "failed";
        }

        // Merge URL data with stored data
        ...
        setTimeout(() => {
          ...
          // Clear stored order data after processing
          ...
          <>
            ...
            <div className="bg-red-50 border border-red-200 rounded-xl p-4 mb-6">
              <p className="text-red-700 text-sm">
                Giao dịch không thể hoàn thành. Vui lòng kiểm tra lại thông tin
                thanh toán và thử lại.
              </p>
            </div>
