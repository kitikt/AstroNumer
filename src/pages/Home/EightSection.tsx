...
const EightSection = () => {
  ...
  const images = [
    {
      ...
      title: "Bojčin Forest, Serbia",
      description: "Path Of Peace",
    },
    {
      src: "/images/image2.png",
      title: "Mystic Valley, Norway",
      description: "Serenity Peak",
    },
    {
      src: "/images/image3.png",
      title: "Emerald Lake, Canada",
      description: "Nature's Haven",
    },
    {
      src: "/images/image4.png",
      title: "Skyfall Ridge, Iceland",
      description: "Ethereal Escape",
    },
    {
      src: "/images/image5.png",
      title: "Lunar Woods, Finland",
  ...
  return (
    <section className={styles.sevenSection}>
      <h1 className={styles.heading}>BLOG HAY MỖI TUẦN</h1>
