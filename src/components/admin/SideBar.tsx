...
import { FiHome, FiUsers, FiSettings, FiShoppingBag, FiAlignRight, FiAlignLeft } from "react-icons/fi";
...
const AdminSidebar = ({ isCollapse, setIsCollapse }: Prop) => {
    ...
    return (
        ...
        >
            <Stack py={5} gap={4}>
                <HStack justify={isCollapse ? 'center' : 'flex-end'} pr={isCollapse ? 0 : 4}>
                    <Button
                        size="sm"
                        ...
                        _hover={{ bg: '#ffffff2b' }}
                    >
                        <Icon as={isCollapse ? FiAlignLeft : FiAlignRight} color={'white'} />
